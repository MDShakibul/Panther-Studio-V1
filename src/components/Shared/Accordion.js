                ...
                >
                  <div className="col-lg-4 col-md-6 overlay-first-col">
                    <div className="overlay-content">
                      ...
                      <p className="overlay-details">
                        ...
                        Customers expect businesses to have an ...
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 overlay-sec-col">
                    <div className="overlay-content">
                      ...
                      <p className="overlay-details">
                        A constant online presence enhances sales opportunities,
                        unrestricted by location or hours. Viewers ...
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 overlay-third-col">
                    <div className="overlay-content">
                      ...
                      <p className="overlay-details">
                        Optimize your website to become your top sales tool.
                        Encourage potential leads to subscribe, explore products
                        ...
                      </p>
                    </div>
                  </div>

          ...
          <div className="row g-3 d-flex align-items-stretch">
            <div className="col-lg-7 col-md-7 d-flex flex-column">
              <div className={`flex-grow-1 ${style.collaborationDetails}`}>
                <p className={`${style.collaborationInfo}`}>
                  {collaboration(active).title}
                </p>
                <p className={`${style.collaborationInfoDetails} mb-0`}>
                  {collaboration(active).details}
                </p>
              </div>
            </div>
              ...
              <div className="flex-grow-1 d-flex align-items-stretch">
                <div className="w-100">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M11.666 11.6666H28.3327M28.3327 11.6666V28.3333M28.3327 11.6666L11.666 28.3333"
                        style={{
                          stroke: active === "passion" ? "#BEE0D6" : "#2E4A45",
                        }}
                        stroke-width="3"
                  ...
                  <div
                    className={`${style.btnCollaborationDetails} ${
                      active === "commitment" ? style.Active : style.Inactive
                    } w-100 mb-3`}
                    onClick={() => handleActive("commitment")}
                  >
                    ...
                    >
                      <path
                        ...
                        style={{
                          stroke:
                            active === "commitment" ? "#BEE0D6" : "#2E4A45",
                        }}
                        stroke-width="3"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                  ...
                  <div
                    className={`${style.btnCollaborationDetails} ${
                      active === "quality" ? style.Active : style.Inactive
                    } w-100`}
                    onClick={() => handleActive("quality")}
                  >
                    ...
                    >
                      <path
                        d="M11.666 11.6666H28.3327M28.3327 11.6666V28.3333M28.3327 11.6666L11.666 28.3333"
                        style={{
                          stroke: active === "quality" ? "#BEE0D6" : "#2E4A45",
                        }}
                        stroke-width="3"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                ...
                >
                  ...
                  >
                    <path
                      d="M7 7H17M17 7V17M17 7L7 17"
                      style={{
                        stroke: active === "commitment" ? "#BEE0D6" : "#2E4A45",
                      }}
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"

        ...
        <div className="row">
          ...
          <div className="col-lg-8">
            <p className={style.serviceDetails}>
              Obtaining an exact website cost estimate can be challenging
              initially. Our pricing considers not just technical needs but also
              post-launch traffic complexities. Achieving local market rankings
              is easier than on a national scale, which requires more intricate
              development. To provide an accurate quote, preliminary research is
              needed. Therefore, we initially offer a pricing range.
              <br />
              <br />
              Acknowledging the need for initial guidance, our initial pricing
              acts as an estimate until further exploration. Once a clear
              strategy is established, a more precise fixed price can be
              provided. Generally, full business websites range from{" "}
              <span className="text-white">€5,000</span> to{" "}
            ...
            <p className={` mt-1 ${style.serviceDetails}`}>
              ...
              launch. This method minimizes your risk, guaranteeing project
